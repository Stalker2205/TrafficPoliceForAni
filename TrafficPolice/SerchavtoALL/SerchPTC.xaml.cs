...
{
    /// <summary>
    /// Логика взаимодействия для SerchPTC.xaml
    /// </summary>
    public partial class SerchPTC : Page
    {
        public SerchPTC()
        {
            InitializeComponent();
        ...
        private void SerchDriverLicence_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                RequestsClass.CheckPts(PtcSeriesTbox.Text.ToString(), PtcNumberTbox.Text.ToString()); return;
            }
