...
namespace TrafficPolice
{
    ...
    /// </summary>
    public partial class SerchIncurance : Page
    {
        public SerchIncurance()
        {
            InitializeComponent();
        ...
        private void SerchDriverLicence_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                RequestsClass.CheckIncurance(IncuranceSeriesTbox.Text.ToString(), IncuranceNumberTbox.Text.ToString()); return;
            }
